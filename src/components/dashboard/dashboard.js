...
function Dashboard({getDashboard,dashboard,profile,id,role}) {
						...
						<div className="col-lg-8 col-md-7">
							<div className="welcome-back">
								<h3 style={{textTransform: 'capitalize'}}>
									<span>Welcome Back !</span><br/> {profile.first_name+" "+profile.last_name}
								</h3>
							</div>
						</div>
						<div className="col-lg-4 col-md-5 mt-auto">
							<div className="date">
								<p><i className="fa fa-calendar fa-fw"></i>{formatDate(new Date())}</p>
							</div>
						</div>
					</div>
				</section>
